 ...
 * @extends {BaseDriver}
 */
// @ts-ignore - Type inference conflict with @appium/base-driver's bundled types
export default class RokuDriver extends BaseDriver {
  ...
  constructor(opts = /** @type {RokuDriverOpts} */({})) {
    // @ts-expect-error - opts type is flexible for driver usage
    super(opts, false);
 ...
 * @typedef {Record<string, any>} RokuDriverOpts
 */
